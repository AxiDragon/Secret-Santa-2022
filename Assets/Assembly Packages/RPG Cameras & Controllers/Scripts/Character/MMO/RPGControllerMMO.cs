...
namespace JohnStairs.RCC.Character.MMO
{
    ...
    public class RPGControllerMMO : RPGController
    {
        ...
        protected override void Update()
        {
            ...
            var vertical = _inputMovement.y;
            // Check if both select buttons are pressed
            if (_inputMoveForwardHalf1 && _inputMoveForwardHalf2) // Let the character move forward
                vertical = 1.0f;
            ...
            var forwardMovementStarted = (_inputMovementStart && _inputMovement.y != 0)
            ...
            var rotation = _inputMovement.x;
            // Get the horizontal strafe direction/input				
            var strafe = _inputStrafe;
            ...
            var inputDirection = new Vector3(strafe, 0, vertical);
            ...
            if (_inputJump) // Signal the motor to jump
                _rpgMotor.Jump();
