...
namespace JohnStairs.RCC.Character
{
    public abstract class RPGController : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Disables the controller, including physics like sliding. For disabling only the user input, use
        ...
        protected virtual void GetInputs(bool logWarnings = false)
        {
            ...
            else
            {
                ...
                // Movement input
                var inputVerticalMovement = Utils.TryGetAxis(Utils.InputPhase.Raw, "Vertical", logWarnings);
                ...
                var inputRotation = Utils.TryGetAxis(Utils.InputPhase.Raw, "Horizontal", logWarnings);
        ...
        /// </summary>
        protected bool _inputMovementStart;

        /// <summary>
        ///     If true, character movement stops this frame
        /// </summary>
        protected bool _inputMovementStop;

        /// <summary>
        ///     Strafe input axis, i.e. sideward movement
        /// </summary>
        protected float _inputStrafe;

        /// <summary>
        ///     If true, strafing started this frame
        /// </summary>
        protected bool _inputStrafeStart;

        /// <summary>
        ///     First input for forward movement via two combined inputs
        /// </summary>
        protected bool _inputMoveForwardHalf1;

        protected bool _inputMoveForwardHalf1Start;
        protected bool _inputMoveForwardHalf1Stop;

        /// <summary>
        ///     Second input for forward movement via two combined inputs
        /// </summary>
        protected bool _inputMoveForwardHalf2;

        protected bool _inputMoveForwardHalf2Start;
        protected bool _inputMoveForwardHalf2Stop;

        /// <summary>
        ///     If true, rotation should be modified
        /// </summary>
        protected bool _inputRotationModifier;

        /// <summary>
        ///     If true, rotation modification started this frame
        /// </summary>
        protected bool _inputRotationModifierStart;
        ...
        /// </summary>
        protected bool _inputSurface;

        /// <summary>
        ///     If true, autorunning is toggled
        /// </summary>
        protected bool _inputToggleAutorunning;

        /// <summary>
        ///     If true, walking is toggled
        /// </summary>
        protected bool _inputToggleWalking;

        /// <summary>
        ///     If true, crouching is toggled
        /// </summary>
        protected bool _inputToggleCrouching;
