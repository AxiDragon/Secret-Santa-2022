...
namespace JohnStairs.RCC
{
    ...
    public class Water : MonoBehaviour
    {
        ...
        /// </summary>
        protected float _globalWaterHeight;
        ...
        protected virtual void Start()
        {
            ...
            if (!collider.isTrigger)
                Debug.LogWarning("Box Collider found on water game object " + name +
                                 " is not set up as trigger! However, this is needed for the swimming mechanic to work");

            _globalWaterHeight = transform.position.y +
                                 (collider.center.y + collider.size.y * 0.5f) * transform.localScale.y;
        ...
        public virtual void DisableShaderZWrite()
        {
            ...
            foreach (var r in renderers) Utils.DisableZWrite(r);
        }
