...
namespace FIMSpace
{
    ...
    public static class FAnimatorMethods
    {
        ...
        /// </summary>
        public static void LerpFloatValue(this Animator animator, string name = "RunWalk", float value = 0f,
            float deltaSpeed = 8f)
        {
            var newValue = animator.GetFloat(name);
        ...
        /// </summary>
        public static bool CheckAnimationEnd(this Animator animator, int layer = 0, bool reverse = false,
            bool checkAnimLoop = true)
        {
                ...
                if (checkAnimLoop)
                {
                    if (info.loop == false)
                        if (!reverse)
                            ...
                            else if (info.normalizedTime < 0.02f) return true;
                }
        ...
        {
            var newWeight = animator.GetLayerWeight(layer);
