    ...
    public partial class BonesStimulator_Editor
    {
        ...
        private void El_Distance(SerializedProperty dprop)
        {
            ...
            if (Application.isPlaying)
                ...
                {
                    GUI.color = c * 0.8f;
                    EditorGUILayout.LabelField("Current Distance: " + Math.Round(Get.CurrentFadeDistance, 2) +
                                               " Blend: " + Mathf.Round(Get.GetEffectBlendWeight() * 100) + "%");
                    GUI.color = c;
                }
        }
        ...
        private void El_Colliders()
        {
            ...
            if (GUILayout.Button(new GUIContent(" " + f + "  " + inclColFoldTitle, FGUI_Resources.TexBehaviourIcon),
            ...
            if (drawInclud)
            {
                ...
                else
                {
                    ...
                    for (var i = 0; i < Get.IncludedColliders.Count; i++)
                    {
                        ...
                        if (Get.IncludedColliders[i] != null)
                        {
                            ...
                            Get.IncludedColliders[i] =
                                (Collider)EditorGUILayout.ObjectField(Get.IncludedColliders[i], typeof(Collider), true);
                ...
                if (GUILayout.Button(
                        new GUIContent("Lock Inspector for Drag & Drop Colliders",
        ...
        private void El_DrawDragAndDropCollidersBox()
        {
            ...
            GUI.Box(drop, "Drag & Drop New Colliders Here",
