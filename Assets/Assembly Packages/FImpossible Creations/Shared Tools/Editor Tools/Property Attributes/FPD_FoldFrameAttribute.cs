...
/// <summary>
///     Creating elegant frame for foldout feature, you need add macro [HideInInspector] for all additional
///     variablesToStore
/// </summary>
public class FPD_FoldFrameAttribute : PropertyAttribute
{
    ...
    /// <param name="variablesToStore">
    ///     name of variables which have to be inside foldout, do it like "new string[3]
    ///     {"variable1", "variable2", "variable3"}" to all this variables add macro [HideInInspecor] (they must be public)
    /// </param>
