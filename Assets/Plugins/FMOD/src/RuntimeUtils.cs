...
namespace FMODUnity
{
    ...
    public static class RuntimeUtils
    {
        ...
        {
            if (Settings.Instance == null || Settings.Instance.LoggingLevel == DEBUG_FLAGS.LOG) Debug.Log(message);
        }
        ...
        {
            if (Settings.Instance == null || Settings.Instance.LoggingLevel >= DEBUG_FLAGS.ERROR) Debug.LogException(e);
        }
#if UNITY_EDITOR
