...
fmod_editor.log";
        ...
        private static readonly List<UpdateTask> updateTasks = new()
        {
            UpdateTask.Create(
                ...
                "Move FMOD for Unity files to match the latest layout.",
            ...
            UpdateTask.Create(
                ...
                "Find event references that use the obsolete [EventRef] attribute " +
        ...
        private void EndPage()
        {
            ...
            using (new EditorGUILayout.HorizontalScope())
            {
                ...
                if (GUILayout.Button(" FMOD Settings ", buttonStyle)) EditorSettings.EditSettings();
