...
namespace NodeCanvas.Tasks.Actions
{
    ...
    {
        [SerializeField] protected SerializedMethodInfo method;

        [SerializeField] protected List<BBObjectParameter> parameters = new();

        [SerializeField] [BlackboardOnly] protected BBObjectParameter returnValue;
        ...
        protected override string info
        {
            get
            {
                ...
                var paramInfo = "";
                for (var i = 0; i < parameters.Count; i++) paramInfo += (i != 0 ? ", " : "") + parameters[i];
