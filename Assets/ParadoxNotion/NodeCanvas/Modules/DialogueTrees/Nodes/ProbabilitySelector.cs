...
namespace NodeCanvas.DialogueTrees
{
    ...
    public class ProbabilitySelector : DTNode
    {
        ...
        private readonly List<Option> childOptions = new();
        ...
        private float GetTotal()
        {
            ...
            for (var i = 0; i < childOptions.Count; i++)
            {
                ...
                if (successIndeces == null || successIndeces.Contains(i)) total += option.weight.value;
            }
        ...
        {
            TaskEditor.TaskFieldMulti(childOptions[i].condition, DLGTree, c => { childOptions[i].condition = c; });
