...
namespace NodeCanvas.DialogueTrees
{
    ...
    {
        [fsSerializeAs("actorParametersMap")] private Dictionary<string, string> _actorParametersMap;

        [SerializeField] [ExposeField] private readonly BBParameter<DialogueTree> _subTree = null;
