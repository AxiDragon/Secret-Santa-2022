...
namespace NodeCanvas.StateMachines
{
    ...
    {
        [SerializeField] private ActionList _onEnterList;

        [SerializeField] private ActionList _onExitList;

        [SerializeField] private ActionList _onUpdateList;
        ...
        /// ---------------------------------------UNITY EDITOR-------------------------------------------
#if UNITY_EDITOR
        [SerializeField] [fsIgnoreInBuild] private bool foldEnter;

        [SerializeField] [fsIgnoreInBuild] private bool foldUpdate;

        [SerializeField] [fsIgnoreInBuild] private bool foldExit;
