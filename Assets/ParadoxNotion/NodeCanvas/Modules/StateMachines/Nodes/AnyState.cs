...
namespace NodeCanvas.StateMachines
{
    ...
    public class AnyState : FSMNode, IUpdatable
    {
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            if (outConnections.Count == 0) EditorGUILayout.HelpBox("No Transition", MessageType.None);
            ...
            dontRetriggerStates = EditorGUILayout.ToggleLeft("Don't Retrigger Running States", dontRetriggerStates);
        }
#endif
    }
}