...
namespace NodeCanvas.BehaviourTrees
{
    ...
    public class Repeater : BTDecorator
    {
        ...
        [ShowIf("repeaterMode", 0)] public BBParameter<int> repeatTimes = 1;

        [ShowIf("repeaterMode", 1)] public RepeatUntilStatus repeatUntilStatus = RepeatUntilStatus.Success;
        ...
        protected override void OnNodeGUI()
        {
            if (repeaterMode == RepeaterMode.RepeatTimes)
            {
                ...
                if (Application.isPlaying)
                    GUILayout.Label("Iteration: " + currentIteration);
            }
