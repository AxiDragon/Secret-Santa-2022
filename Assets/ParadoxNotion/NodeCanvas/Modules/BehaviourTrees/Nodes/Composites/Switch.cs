...
namespace NodeCanvas.BehaviourTrees
{
    ...
    public class Switch : BTComposite
    {
        ...
        public BBObjectParameter enumCase = new(typeof(Enum));

        private Dictionary<int, int> enumCasePairing;

        [ShowIf("selectionMode", 0)] public BBParameter<int> intCase;

        [ShowIf("selectionMode", 0)] public OutOfRangeMode outOfRangeMode = OutOfRangeMode.LoopIndex;

        private int runningIndex;

        [Tooltip("The selection mode used.")] public CaseSelectionMode selectionMode = CaseSelectionMode.IndexBased;
        ...
        protected override void OnNodeGUI()
        {
            ...
            GUILayout.Label(
                selectionMode == CaseSelectionMode.IndexBased ? "Current = " + intCase : enumCase.ToString());
        }
