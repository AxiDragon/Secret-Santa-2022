    ...
    public class ProbabilitySelector : BTComposite
    {
        ...
        protected override void OnNodeInspectorGUI()
        {
            ...
            for (var i = 0; i < childWeights.Count; i++)
            {
                ...
                childWeights[i] = (BBParameter<float>)BBParameterEditor.ParameterField("Weight", childWeights[i]);
            ...
            GUILayout.BeginHorizontal();
            failChance = (BBParameter<float>)BBParameterEditor.ParameterField("Direct Failure Chance", failChance);
