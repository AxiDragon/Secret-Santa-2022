...
namespace NodeCanvas.Editor
{
    ...
    public class StatementDrawer : ObjectDrawer<Statement>
    {
        public override Statement OnGUI(GUIContent content, Statement instance)
        {
            ...
            instance.text = EditorGUILayout.TextArea(instance.text, Styles.wrapTextArea, GUILayout.Height(100));
            instance.audio =
                EditorGUILayout.ObjectField("Audio File", instance.audio, typeof(AudioClip), false) as AudioClip;
