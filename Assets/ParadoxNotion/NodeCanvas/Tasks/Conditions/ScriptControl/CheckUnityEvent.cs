...
namespace NodeCanvas.Tasks.Conditions
{
    ...
    {
        ///----------------------------------------------------------------------------------------------
        [SerializeField] private SerializedUnityEventInfo _eventInfo;
        ...
        protected override void OnTaskInspectorGUI()
        {
            ...
            if (targetMember != null)
            {
                ...
                EditorGUILayout.LabelField("Type", targetMember.RTReflectedOrDeclaredType().FriendlyName());
    ...
    public class CheckUnityEvent<T> : ConditionTask, IReflectedWrapper, IMigratable<CheckUnityEvent_0<T>>
    {
        ...
        [SerializeField] [BlackboardOnly] private readonly BBParameter<T> saveAs = null;
    ...
    public class CheckUnityEventValue<T> : ConditionTask, IReflectedWrapper, IMigratable<CheckUnityEventValue_0<T>>
    {
        ...
        [SerializeField] private readonly BBParameter<T> checkValue = null;
        private UnityEvent<T> unityEvent;
