...
namespace NodeCanvas.Tasks.Conditions
{
    ...
    public class CheckCollision2D_Rigidbody : ConditionTask<Rigidbody2D>
    {
        ...
        [TagField] public string objectTag = "Untagged";

        [BlackboardOnly] public BBParameter<Vector3> saveContactNormal;

        [BlackboardOnly] public BBParameter<Vector3> saveContactPoint;

        [BlackboardOnly] public BBParameter<GameObject> saveGameObjectAs;

        public bool specifiedTagOnly;

        private bool stay;

        protected override string info => checkType + (specifiedTagOnly ? " '" + objectTag + "' tag" : "");
