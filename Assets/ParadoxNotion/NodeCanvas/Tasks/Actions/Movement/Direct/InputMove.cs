...
namespace NodeCanvas.Tasks.Actions
{
    ...
    {
        [BlackboardOnly] public BBParameter<float> forward;
        ...
        [BlackboardOnly] public BBParameter<float> strafe;

        [BlackboardOnly] public BBParameter<float> turn;

        [BlackboardOnly] public BBParameter<float> up;
