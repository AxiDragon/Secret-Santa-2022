...
namespace ParadoxNotion.Design
{
    ...
    {
        private static readonly Dictionary<MemberInfo, XmlElement> cachedElements = new();
        private static readonly Dictionary<MemberInfo, string> cachedSummaries = new();
        ...
        {
            return GetMethodParameter(method, parameter.Name);
        }
        ...
        private static XmlElement GetTypeDoc(Type type)
        {
            return GetDoc(type, $"T:{type.FullName}");
        }
