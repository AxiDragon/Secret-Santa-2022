...
namespace ParadoxNotion.Design
{
    ...
    public static class Styles
    {
        ...
        public static GUIStyle highlightBox =>
            _highlightBox ?? (_highlightBox = new GUIStyle("LightmapEditorSelectedHighlight"));

        public static GUIStyle toolbarSearchTextField =>
            _toolbarSearchField ?? (_toolbarSearchField = new GUIStyle("ToolbarSeachTextField"));

        public static GUIStyle toolbarSearchCancelButton => _toolbarSearchButton ??
                                                            (_toolbarSearchButton =
                                                                new GUIStyle("ToolbarSeachCancelButton"));

        public static GUIStyle shadowedBackground =>
            _shadowedBackground ?? (_shadowedBackground = new GUIStyle("CurveEditorBackground"));
