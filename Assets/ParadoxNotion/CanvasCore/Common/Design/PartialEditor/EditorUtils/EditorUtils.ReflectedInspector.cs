...
namespace ParadoxNotion.Design
{
    ...
    partial class EditorUtils
    {
        ...
        public static object DirectFieldControl(GUIContent content, object value, Type t,
            UnityObject unityObjectContext, object[] attributes, out bool handled, params GUILayoutOption[] options)
        {
            handled = true;
            ...
            if (typeof(UnityObject).IsAssignableFrom(t) || t.IsInterface)
                if (value == null || value is UnityObject)
                {
                    ...
                    if (unityObjectContext != null && newValue != null)
                        ...
                        {
                            Logger.LogWarning("Assets can not have scene object references", "Editor",
                                unityObjectContext);
            ...
            //Check Type second
            if (t == typeof(Type)) return Popup(content, (Type)value, TypePrefs.GetPreferedTypesList(true), options);
