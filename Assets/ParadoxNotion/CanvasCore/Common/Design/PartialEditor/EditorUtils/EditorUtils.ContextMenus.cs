    ...
    partial class EditorUtils
    {
        ...
        public static GenericMenu GetMenu<T>(List<T> options, T current, Action<T> callback)
        {
            ...
            foreach (var _option in options)
            {
                ...
                menu.AddItem(new GUIContent(label), Equals(current, option), () => { callback(option); });
            }
            ...
            string subCategory = null)
        {
            ...
            GenericMenu.MenuFunction2 Selected = delegate(object selectedType) { callback((Type)selectedType); };
            ...
            GenericMenu menu = null, string subCategory = null, bool showAddTypeOption = false)
        {
            ...
            GenericMenu.MenuFunction2 Selected = t => { callback((Type)t); };
        ...
        {
            return Internal_GetFieldSelectionMenu(BindingFlags.Public | BindingFlags.Instance, type, fieldType,
                callback, menu, subMenu);
        }

        public static GenericMenu GetStaticFieldSelectionMenu(Type type, Type fieldType, Action<FieldInfo> callback,
            GenericMenu menu = null, string subMenu = null)
        {
            return Internal_GetFieldSelectionMenu(
                BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy, type, fieldType, callback,
                menu, subMenu);
        }
            ...
            Action<FieldInfo> callback, GenericMenu menu = null, string subMenu = null)
        {
            ...
            GenericMenu.MenuFunction2 Selected = delegate(object selectedField) { callback((FieldInfo)selectedField); };
        ...
        public static GenericMenu GetInstancePropertySelectionMenu(Type type, Type propType,
            ...
            string subMenu = null)
        {
            return Internal_GetPropertySelectionMenu(BindingFlags.Public | BindingFlags.Instance, type, propType,
                callback, mustRead, mustWrite, menu, subMenu);
        }
        ...
        public static GenericMenu GetStaticPropertySelectionMenu(Type type, Type propType,
            ...
            string subMenu = null)
        {
            return Internal_GetPropertySelectionMenu(
        ...
        public static GenericMenu GetInstanceMethodSelectionMenu(Type type, Type returnType, Type acceptedParamsType,
            ...
            GenericMenu menu = null, string subMenu = null)
        {
            return Internal_GetMethodSelectionMenu(BindingFlags.Public | BindingFlags.Instance, type, returnType,
        ...
        public static GenericMenu GetStaticMethodSelectionMenu(Type type, Type returnType, Type acceptedParamsType,
            ...
            GenericMenu menu = null, string subMenu = null)
        {
            return Internal_GetMethodSelectionMenu(
        ...
        public static GenericMenu GetInstanceEventSelectionMenu(Type type, Type argType, Action<EventInfo> callback,
            GenericMenu menu = null, string subMenu = null)
        {
            return Internal_GetEventSelectionMenu(BindingFlags.Public | BindingFlags.Instance, type, argType, callback,
                menu, subMenu);
        }
        ...
        public static GenericMenu GetStaticEventSelectionMenu(Type type, Type argType, Action<EventInfo> callback,
            GenericMenu menu = null, string subMenu = null)
        {
            return Internal_GetEventSelectionMenu(
                BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy, type, argType, callback,
                menu, subMenu);
        }
            ...
            Action<EventInfo> callback, GenericMenu menu = null, string subMenu = null)
        {
            ...
            GenericMenu.MenuFunction2 Selected = delegate(object selectedEvent) { callback((EventInfo)selectedEvent); };

            var eventType = argType == null ? typeof(Action) : typeof(Action<>).MakeGenericType(argType);
