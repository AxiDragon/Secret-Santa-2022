...
namespace ParadoxNotion.Design
{
    ...
    {
        private static Dictionary<Type, string> cachedCopies = new();
        private static Dictionary<Type, object> cachedObjects = new();
        ...
        {
            return cachedCopies.TryGetValue(typeof(T), out var json);
        }
        ...
        {
            return cachedObjects.TryGetValue(typeof(T), out var obj);
        }
