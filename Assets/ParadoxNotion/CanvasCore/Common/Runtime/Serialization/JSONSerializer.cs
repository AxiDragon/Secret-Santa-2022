...
namespace ParadoxNotion.Serialization
{
    ...
    public static class JSONSerializer
    {
            ...
            bool pretyJson = false)
        {
            lock (serializerLock)
            {
                ...
                var overrideConverterType =
                    typeof(Object).RTIsAssignableFrom(type) ? typeof(fsReflectedConverter) : null;
        ...
        public static T TryDeserializeOverwrite<T>(T instance, string json, List<Object> references = null)
            where T : class
        {
        ...
        private static object Internal_Deserialize(Type type, string json, List<Object> references, object instance)
        {
            lock (serializerLock)
            {
                ...
                //UnityObject converter will still be used for every serialized property found within the object though.
                var overrideConverterType = instance is Object ? typeof(fsReflectedConverter) : null;
