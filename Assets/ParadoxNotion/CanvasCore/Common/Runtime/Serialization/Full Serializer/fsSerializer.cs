...
namespace ParadoxNotion.Serialization.FullSerializer
{
    ...
    public class fsSerializer
    {
        ...
        /// </summary>
        private readonly Dictionary<Type, fsBaseConverter> _cachedOverrideConverterInstances;

        ///<summary> A cache from type to the set of processors that are interested in it.</summary>
        private readonly Dictionary<Type, List<fsObjectProcessor>> _cachedProcessors;
        ...
        private readonly Stack<ISerializationCollector> _collectors;
