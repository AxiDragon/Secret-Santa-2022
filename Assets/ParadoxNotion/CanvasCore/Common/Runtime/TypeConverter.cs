...
namespace ParadoxNotion
{
    ...
    public static class TypeConverter
    {
        ...
        public static Func<object, object> Get(Type fromType, Type toType)
        {
            ...
            if (typeof(Object).RTIsAssignableFrom(fromType) && toType == typeof(bool)) return value => value != null;
            ...
            if (fromType == typeof(GameObject) && toType == typeof(Quaternion))
                return value =>
                {
                    return value as GameObject != null
                        ? (value as GameObject).transform.rotation
                        : Quaternion.identity;
                };
            ...
            if (typeof(Component).RTIsAssignableFrom(fromType) && toType == typeof(Quaternion))
                return value =>
                {
                    return value as Component != null
                        ? (value as Component).transform.rotation
                        : Quaternion.identity;
                };
