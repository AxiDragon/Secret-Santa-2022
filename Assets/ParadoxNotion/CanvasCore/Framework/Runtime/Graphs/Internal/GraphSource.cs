...
namespace NodeCanvas.Framework.Internal
{
    ...
    public class GraphSource : ISerializationCollector
    {
        ...
        [fsSerializeAs("connections")] private List<Connection> _connections;

        [fsSerializeAs("derivedData")] private object _derivedData;

        [fsSerializeAs("localBlackboard")] private BlackboardSource _localBlackboard;

        [fsSerializeAs("nodes")] private List<Node> _nodes;

        [fsSerializeAs("type")] private string _type;
