...
namespace NodeCanvas.Framework
{
    ...
    public abstract partial class Graph : ScriptableObject, ITaskSystem, ISerializationCallbackReceiver
    {
        ...
        [SerializeField] private GraphSource _graphSource = new();
        ...
        [NonSerialized] private bool haltForUndo;
        ...
        {
            if (string.IsNullOrEmpty(_serializedGraph)) //we dont really have anything to validate in this case
                return;
            ...
            Action<bool> callback = null)
        {
            ...
            else //if the graph has pre-initialized with same targets, this call does basically nothing,
        ...
        public void RemoveNode(Node node, bool recordUndo = true, bool force = false)
        {
            ...
            if (!Application.isPlaying) //auto reconnect parent & child of deleted node. Just a workflow convenience
...
#if UNITY_EDITOR
            if (GraphEditorUtility.activeElement == connection) GraphEditorUtility.activeElement = null;
#endif
            ...
            Vector2 originPosition = default)
        {
            ...
            {
                var newNode = targetGraph != null ? original.Duplicate(targetGraph) : JSONSerializer.Clone(original);
