...
namespace NodeCanvas.Framework
{
    ...
    {
        [fsSerializeAs("overrideAgent")] protected internal TaskAgentParameter _agentParameter;
        ...
        ///----------------------------------------------------------------------------------------------
        [fsSerializeAs("_isDisabled")] private bool _isUserDisabled;
        ...
        /// </summary>
        public EventRouter router => _eventRouter != null
            ? _eventRouter
