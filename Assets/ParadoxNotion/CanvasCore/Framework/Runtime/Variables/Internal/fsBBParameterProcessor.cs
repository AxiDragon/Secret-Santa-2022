    ...
    public class fsBBParameterProcessor : fsRecoveryProcessor<BBParameter, MissingBBParameterType>
    {
            ...
            ref fsData data)
        {
            ...
            if (bbParam != null && bbParam.GetType().RTIsGenericType())
            {
                ...
                if (serializer.TryDeserialize(data, varType, ref prevInstance)
                    .Succeeded) //if success and assignalbes, set the BBParameter instance value and serialize back again.
