...
namespace NodeCanvas.Framework
{
    ...
    public static class IBlackboardExtensions
    {
        ...
        /// <summary>
        ///     Set the value of the Variable variable defined by its name. If a data by that name and type doesnt exist, a
        ///     new data is added by that name
        /// </summary>
        ...
        public static Variable ChangeVariableType(this IBlackboard blackboard, Variable target, Type newType)
        {
            ...
            var newVariable = (Variable)Activator.CreateInstance(variableType, target.name, target.ID);
