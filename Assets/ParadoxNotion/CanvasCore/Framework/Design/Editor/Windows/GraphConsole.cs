...
namespace NodeCanvas.Editor
{
    ...
    public class GraphConsole : EditorWindow
    {
        ...
        {
            if (msg.tag == "Editor") return false;
        ...
        private static void ProccessMessage(Logger.Message msg)
        {
            ...
            var graph = Graph.GetElementGraph(msg.context);
            if (graph != null)
                unityContext = graph.agent != null ? graph.agent.gameObject : graph;
            else
