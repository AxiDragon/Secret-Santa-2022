    ...
    public class GraphOwnerInspector : UnityEditor.Editor
    {
        ...
        private void DoPrefabRelatedGUI()
        {
            ...
            if (owner.graphIsBound)
            {
                var case1 = PrefabUtility.IsPartOfPrefabAsset(owner) ||
                            PrefabStageUtility.GetCurrentPrefabStage()?.prefabContentsRoot == owner.gameObject;
        ...
        private void DoExposedVariablesMapping()
        {
            ...
            foreach (var variable in subTreeVariables)
            {
                ...
                if (owner.exposedParameters == null) owner.exposedParameters = new List<ExposedParameter>();
