...
namespace NodeCanvas.Editor
{
    ...
    public static class GraphEditorUtility
    {
        ...
        private static readonly WeakReference<IGraphElement> _activeElement = new(null);
        private static WeakReferenceList<IGraphElement> _activeElements = new();
        ...
        public static IEnumerable<Type> GetDropedReferenceNodeTypes<T>(Object obj) where T : IGraphElement
        {
        ...
        public static void ScanForStructTypesAndAppendThem(Graph graph)
        {
            ...
            JSONSerializer.SerializeAndExecuteNoCycles(typeof(GraphSource), graph.GetGraphSource(), (o, d) =>
            {
        ...
        public static Graph DeepCopy(Graph root)
        {
            ...
            foreach (var subGraphNode in copy.allNodes.OfType<IGraphAssignable>())
                if (subGraphNode.subGraph != null) //duplicate the existing sub-graph and assign the copy to node.
