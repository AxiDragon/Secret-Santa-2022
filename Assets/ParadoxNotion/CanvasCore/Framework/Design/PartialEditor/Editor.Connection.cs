...
namespace NodeCanvas.Framework
{
    partial class Connection
    {
        ...
        ///----------------------------------------------------------------------------------------------
        [SerializeField] [fsIgnoreInBuild] private bool _infoCollapsed;
        ...
        public virtual PlanarDirection direction => PlanarDirection.Auto;
        ...
        public void DrawConnectionGUI(Vector2 fromPos, Vector2 toPos)
        {
            ...
            CurveUtils.ResolveTangents(fromPos, toPos, sourceNode.rect, targetNode.rect, Prefs.connectionsMLT,
                direction, out fromTangent, out toTangent);
        ...
        private void DrawConnection(Vector2 fromPos, Vector2 toPos)
        {
            ...
            if (isRelinkingActive)
            {
                ...
                CurveUtils.ResolveTangents(fromPos, toPos, Prefs.connectionsMLT, direction, out fromTangent,
                    out toTangent);
                size = defaultSize;
            }
        ...
        private GenericMenu GetConnectionMenu()
        {
            ...
            if (assignable != null)
            {
                ...
                if (CopyBuffer.TryGet(out Task copy))
