...
namespace NodeCanvas.Framework
{
    partial class Graph
    {
        ...
        {
            return OnNodesContextMenu(menu, nodes);
        }
        ...
        public void CallbackOnDropAccepted(Object o, Vector2 canvasMousePos)
        {
            ...
            foreach (var type in GraphEditorUtility.GetDropedReferenceNodeTypes<IGraphAssignable>(o))
        ...
        protected virtual GenericMenu OnNodesContextMenu(GenericMenu menu, Node[] nodes)
        {
            return menu;
        }
